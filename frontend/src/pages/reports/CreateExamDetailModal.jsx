...
const CreateExamDetailModal = ({ examDetail, exams, classes, onSave, onCancel }) => {
 ...
 const defaultExamDate = is_ad ? formattedAd : formattedBs;

 const initialFormData = examDetail
    ? examDetail
    : {
        exam: exams.id || '',
        subject: '',
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            {is_ad ? (
              ...
              <NepaliDatePicker
                value={formData.exam_date || defaultExamDate}
                onChange={(date) => {
                  setFormData((prev) => ({ ...prev, exam_date: date || defaultExamDate }));
                }}

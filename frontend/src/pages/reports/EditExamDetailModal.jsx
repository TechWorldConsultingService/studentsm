...
const EditExamDetailModal = ({ examDetail, exams, classes, onSave, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-h-full md:w-1/2 lg:w-1/3 overflow-auto">
        <h2 className="text-2xl font-semibold text-purple-700 mb-4">Edit Exam Detail</h2>
        <form onSubmit={formik.handleSubmit}>
          ...
          {/* Class Assigned */}
          <div className="mb-4">
            <label className="block text-gray-700 font-semibold mb-2">Class Assigned</label>
            <select
              id="class_assigned"
              name="class_assigned"
            ...
            {formik.touched.class_assigned && formik.errors.class_assigned && (
              <div className="text-red-500 text-sm">{formik.errors.class_assigned}</div>
            )}
          </div>
          ...
          <div className="mb-4">
            ...
            {formik.touched.full_marks && formik.errors.full_marks && (
              <div className="text-red-500 text-sm">{formik.errors.full_marks}</div>
            )}
          </div>
          ...
          <div className="mb-4">
            ...
            {formik.touched.pass_marks && formik.errors.pass_marks && (
              <div className="text-red-500 text-sm">{formik.errors.pass_marks}</div>
            )}
          </div>
          ...
          <div className="mb-4">
            ...
            {formik.touched.exam_date && formik.errors.exam_date && (
              <div className="text-red-500 text-sm">{formik.errors.exam_date}</div>
            )}
          </div>

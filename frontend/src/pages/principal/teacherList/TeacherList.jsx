...
const TeacherList = () => {
  ...
  const handleDeleteTeacher = async () => {
    ...
    try {
      await axios.delete(`http://localhost:8000/api/teachers/${teacherToDelete}/delete/`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${access}`,
        },
      ...
      toast.error("Error deleting teacher:", error.response?.data?.detail || error.message);
    }
  };
      ...
      <div className="bg-purple-50 p-6">
        <div className="bg-white p-6 rounded-lg shadow-lg border border-purple-300">
          ...
          <div className="mt-6">
            ...
            <p className="mt-4 text-gray-600">Teacher list with their details.</p>
          </div>
          ...
          <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 md:w-1/2">
              ...
              <div className="mt-4">
                ...
                <p className="text-gray-700">
                  <strong>Name:</strong> {selectedTeacher.user.first_name} {selectedTeacher.user.last_name}
                </p>
                <p className="text-gray-700">

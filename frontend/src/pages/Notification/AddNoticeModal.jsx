...
const AddNoticeModal = ({ onClose, refreshNotices }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    let payload = { message, receiver_role: receiverRole };
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-11/12 md:w-1/2">
        <h2 className="text-2xl font-bold mb-6 text-purple-800">Send Notice</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Class Selection (if receiverRole == student) */}

    ...
    <MainLayout>
      <div className="bg-purple-50 min-h-screen p-6">
        <div className="bg-white p-6 rounded-lg shadow-lg border border-purple-300">
          ...
          <div className="mt-6">
            <h2 className="text-xl font-semibold text-purple-700">All Notices</h2>
          </div>
          
          {loading ? (
            <div className="mt-6 text-center text-gray-600">Loading notices...</div>
          ) : notices.length > 0 ? (
                  ...
                  {notices.map((notice) => (
                    <tr key={notice.id} className="border-b hover:bg-purple-50">
                      <td className="px-4 py-2">
                        {notice.sender?.username || "Unknown"}
                      </td>
            ...
            <div className="mt-6 text-center text-gray-600">No notices found.</div>
          )}
        </div>

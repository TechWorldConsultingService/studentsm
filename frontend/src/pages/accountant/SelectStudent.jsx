...
import {setSelectedPaymentUserInformation} from "../../redux/reducerSlices/paymentSlice"
...
const SelectStudent = ({
  ...
  // Ensure property names match the API response. Here, using "roll_no" for filtering.
  const filteredStudents = students.filter((student) => {
    const lowerCaseSearch = searchTerm.toLowerCase();
    const nameMatch = student.full_name?.toLowerCase().includes(lowerCaseSearch);
    const rollMatch = student.roll_no?.toString().includes(searchTerm);
  ...
  const handleStudentSelect = (studentInfo) => {
    setSelectedStudentId(String(studentInfo.id));
    dispatch(setSelectedPaymentUserInformation(studentInfo));
    setErrorMessage("");
  };

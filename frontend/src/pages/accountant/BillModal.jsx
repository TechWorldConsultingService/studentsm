    ...
    newWindow.document.write(`
      <html>
        <head>
          ...
          <style>
            /* Force a white background for print */
            body {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gray-700 bg-opacity-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 md:w-1/2 max-h-full overflow-auto">
        ...
        {/* Content */}
        <div className="p-4" id="print-bill">
          {loading ? (
            <p>Loading Bill...</p>
          ) : billData ? (
            <div
            ...
            >
              ...
              {/* Header Info (Name, Class, A/C No, etc.) */}
                ...
                <table className="w-full text-left border border-blue-600">
                  <thead>
                    <tr className="bg-blue-100">
                      <th className="border border-blue-600 px-2 py-1 w-12">S.No</th>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="border border-blue-600 p-2">
                  <p>
                    <span className="font-semibold">Dr/Cr Balance From Last Month:</span>{" "}
